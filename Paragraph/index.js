...
// The above function is to shuffle  para it is ready on google
...
const generate = () => {
    ...
    if (isNaN(item.value) || item.value > 9 || item.value < 0 ){
        ...
        // map is used for  creates a new array by calling a function on every element of the original array and storing the results in a new array.
       
        // slice is used in array to get the value
